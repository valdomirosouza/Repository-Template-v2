...
> **Version:** 2.3.0 | **Last updated:** 2026-06-06
...
| ADRs          | `docs/adr/`                               | ADR-0001–ADR-0046 all binding; 0030–0041 cover RTK, Agentic SDLC onboarding, sub-agent registry, session durability, escalation protocol, AI-assisted CI review, cyber defense, governance gate, learn stage, tool registry, maturity model, context graph; 0042 K8s probes; 0043–0046 OTel agentic observability |
