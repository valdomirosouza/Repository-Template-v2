...
| ADRs          | `docs/adr/`                               | ADR-0001–ADR-0052 all binding; 0030–0041 cover RTK, Agentic SDLC onboarding, sub-agent registry, session durability, escalation protocol, AI-assisted CI review, cyber defense, governance gate, learn stage, tool registry, maturity model, context graph; 0042 K8s probes; 0043–0046 OTel agentic observability; 0047–0051 Secure-by-Design (spec contracts, zero-trust tooling, behavioral monitoring, adversarial testing, model behavioral contracts); 0052 Agentic SDLC E2E workflow |
| Process       | `docs/process/`                           | Workflow (13-phase), RACI, HITL-GOVERNANCE, SPRINT-TRACKING, RETROSPECTIVE-GUIDE, DoR, DoD, DoR-Release                                                                                                                                                                                                                                                                                                                                                                                    |
...
**Full 13-phase lifecycle reference:** `docs/process/WORKFLOW.md` (ADR-0052)
