...
| [ADR-0082](ADR-0082-automated-restore-drill.md)                            | Automated restore-drill verification (scripted restores + dry-run drill; CI workflow deferred to RFC) | Proposed   | 2026-06-15 |
