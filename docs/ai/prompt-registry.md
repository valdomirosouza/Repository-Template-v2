...
| `harness.evaluator`   | `prompts/harness/evaluator.v2.md` (loaded by `src/agents/prompt_loader.py`)                     | Score generator output (quality/originality/craft/functionality/**groundedness**)       | `settings.llm_model` | `tests/model_contract/` (incl. `test_groundedness.py`) | AI Governance Lead | 2.0 |
